...
class StoreApartmentRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'title.max' => 'The title must be a maximum of 100 characters long!',
            'title.unique' => 'This title already exists. The title must be unique!',
            ...
            'square_meters.max' => 'Square meters must be a maximum of 15 characters long!',

            // ADDRESS
            'address.required' => 'The address is required!',
            'address.max' => 'The address must be a maximum of 100 characters long!',
            ...
            'cover_img.max' => 'The cover image cannot exceed 2048 kil'
