    ...
    $(document).ready(function() {
        ...
        function validateForm() {
            ...
            if (!title) {
                ...
                showError('title', 'The title must be a maximum of 100 characters long!');
                isValid = false;
            } else {
                hideError('title');
            }
            ...
            if (!bathrooms) {
                ...
                isValid = false;
            } else if (!$.isNumeric(bathrooms) || parseInt(bathrooms) != bathrooms) {
            ...
            if (!squareMeters) {
                ...
                showError('square_meters', 'Square meters must be a maximum of 15 characters long!');
                isValid = false;
            } else {
            ...
            if (!address) {
                ...
                showError('address', 'The address must be a maximum of 100 characters long!');
                isValid = false;
            } else {
                hideError('address');
            }
            ...
            if (!coverImg) {
                ...
                if (['jpg', 'jpeg', 'png'].indexOf(extension) == -1) {
                    showError('cover_img', 'The cover image must be in .jpg, .png, or .jpeg format!');
                    isValid = false;
                } else {
                    hideError('cover_img');
                }
